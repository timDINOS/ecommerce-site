...
import django.db.models.deletion, django_countries.fields


class CardMigration(migrations.Migration):
    initial = True
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields = [
                ...
                ('currently_delivered', models.BooleanField(default=False)),
                ...
                ('coupon', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.Address')),
            ],
        ),
        migrations.CreateModel(
            name='Refund',
        ...
        migrations.AddField(
            model_name='order',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.USER_AUTH_MODEL),
        ),
    ]